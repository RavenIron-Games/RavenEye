# Builds the store release zip: RavenIronStudios-RavenEye-<version>.zip in dist\.
...
$csproj = "$root\RavenEye\RavenEye.csproj"
...
$dll = "$root\RavenEye\bin\Release\RavenEye.dll"
...
$zip = "$dist\RavenIronStudios-RavenEye-$version.zip"
